...
public class OpenApiGenerationTest {
    ...
    private com.fooddelivery.common.security.AuctionTokenService auctionTokenService;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.advertisement.bidding.constants.TrackingUrlConstants trackingUrlConstants;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.advertisement.bidding.cache.CacheProvider cacheProvider;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.advertisement.bidding.pricing.BidPricer bidPricer;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.advertisement.bidding.matcher.CampaignMatcher campaignMatcher;


    @org.springframework.boot.test.mock.mockito.MockBean
    private com.fooddelivery.advertisement.bidding.service.BiddingService biddingService;

    @org.springframework.boot.autoconfigure.SpringBootApplication(scanBasePackages = {"com.fooddelivery.advertisement.bidding.controller"}, excludeName = {"org.springframework.boot.autoconfigure.security.servlet.SecurityAutoConfiguration", "org.springframework.boot.actuate.autoconfigure.security.servlet.ManagementWebSecurityAutoConfiguration", "org.springframework.boot.autoconfigure.security.reactive.ReactiveSecurityAutoConfiguration", "org.springframework.boot.actuate.autoconfigure.security.reactive.ManagementReactiveSecurityAutoConfiguration", "org.springframework.boot.autoconfigure.security.oauth2.resource.servlet.OAuth2ResourceServerAutoConfiguration"})
